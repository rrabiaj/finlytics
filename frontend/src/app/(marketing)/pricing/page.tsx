      ...
      <div className="max-w-4xl mx-auto overflow-x-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-sm">
            <tr className="border-b">
              <td className="py-4">AI Assistant Queries</td>
              <td className="py-4 text-center text-muted-foreground">-</td>
              <td className="py-4 text-center">50/mo</td>
            ...
            <tr className="border-b">
              ...
              <td className="py-4 text-center text-muted-foreground">-</td>
              <td className="py-4 text-center text-muted-foreground">-</td>
              <td className="py-4 text-center font-bold">Yes</td>
            </tr>
            <tr className="border-b">
              <td className="py-4">Public API</td>
              <td className="py-4 text-center text-muted-foreground">-</td>
              <td className="py-4 text-center font-bold">Read-only</td>
              <td className="py-4 text-center font-bold">Full Access</td>
            </tr>
            <tr className="border-b">
              <td className="py-4">Financial Forecasting</td>
              <td className="py-4 text-center text-muted-foreground">-</td>
